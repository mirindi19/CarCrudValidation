 ...
 * @author Mirindi
 */
@WebServlet (name="UpdateCarManagement", urlPatterns = {"/UpdateCar"})
public class UpdateCarManagement extends HttpServlet{
    ...
    protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException , IOException{
       ...
       if(validation(car)){
         GenericDao updt= new GenericDao(Car_22135.class);
            updt.update(car);
